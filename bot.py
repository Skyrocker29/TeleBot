...
keyboard1.row('Привет', 'Работаем', 'Деньги нужны', 'До свидания', "Повысте зарплату")
...
def send_text(message):
	...
	elif message.sticker.lower() == 'повысте зарплату':
		bot.send_message(message.chat.id, 'CAACAgIAAxkBAAEBEFlfEaFGWl9Kil_F30eeU5KQDQAB2kMAAnsBAAIWQmsK0RR4Y7X4k40aBA')
